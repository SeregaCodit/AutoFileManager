...
For more comfortable using FileManager with multiple tasks you can create an .sh file or modify [strat_all_tasks.sh](https://github.com/SeregaCodit/DataForge/blob/main/strat_all_tasks.sh) with list of your commands. And run all of them just by one simple command:
